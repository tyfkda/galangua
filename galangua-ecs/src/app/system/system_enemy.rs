...
pub fn do_move_owl(
    ...
    match owl.state {
        ...
        OwlState::CaptureAttack(phase) => {
            run_capture_attack(phase, owl, enemy, entity, posture, speed, tractor_beam, &formation, game_info, commands);
            forward(posture, speed);
        }
...
pub fn do_move_tractor_beam(tractor_beam: &mut TractorBeam, commands: &mut CommandBuffer) {
        ...
        Opening => {
            ...
            if an != pn {
                ...
                let entity = commands.push((
                    SpriteDrawable { sprite_name: TRACTOR_BEAM_SPRITE_NAMES[i], offset: ZERO_VEC },
